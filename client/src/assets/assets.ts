            ...
            <div class="flex pt-14">
                ...
                <aside class="fixed left-0 top-14 bottom-0 w-60 bg-yt px-3 py-4 overflow-y-auto hidden lg:block">
                    <nav class="space-y-2">
                        ...
                        <a target="_blank" href="https://www.linkedin.com/in/baljeet-sharma/" class="flex items-center gap-4 px-3 py-2 rounded-lg hover:bg-yt2"> <img src="https://media.licdn.com/dms/image/v2/D5603AQEfH7_ZROE1Nw/profile-displayphoto-scale_400_400/B56ZlMvWFZJoAg-/0/1757929104751?e=1768435200&v=beta&t=V08kiCfUZfyg91HcKg3yi1ip_JRMFvWxYy5_F89MMvk" class="rounded-full size-7" /> Baljeet </a>
                        
                        <a  target="_blank" href="https://github.com/BaljeetSharma98" class="flex items-center gap-4 px-3 py-2 rounded-lg hover:bg-yt2"> <img src="https://github.githubassets.com/assets/pull-shark-default-498c279a747d.png" class="rounded-full size-7" /> GitHub </a>
